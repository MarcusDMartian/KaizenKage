   ...
   return (
      <div className="max-w-3xl mx-auto space-y-6 pb-24 px-4 md:px-0">
         ...
         <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-xl shadow-slate-200/50 border border-white/60 overflow-hidden group">
            ...
            <div className="px-6 pb-6">
               <div className="relative -mt-12 mb-4 flex justify-between items-end">
                  <img src={currentUser.avatarUrl} alt="" className="w-24 h-24 rounded-full border-4 border-white shadow-lg bg-white" />
               </div>
               ...
               <div>
                  <div className="flex items-start justify-between">
                     <div>
                        ...
                        <p className="text-slate-500">{currentUser.role} • {currentUser.team}</p>
                     </div>
                  ...
                  <div className="flex justify-between items-end mb-2">
                     <div>
                        ...
                        <div className="flex items-baseline gap-1">
                           <span className="text-lg font-bold text-slate-800">{currentUser.points.toLocaleString()}</span>
                           <span className="text-xs font-medium text-slate-500">/ {currentUser.nextLevelPoints.toLocaleString()} XP</span>
                        </div>
                     </div>
               ...
               <div className="grid grid-cols-3 gap-4 mt-4">
                  <div className="bg-white p-4 rounded-2xl text-center border border-slate-100 shadow-sm">
                     <span className="block text-2xl font-bold text-indigo-600">{currentUser.points.toLocaleString()}</span>
         ...
         <button
            ...
            className="w-full bg-white/70 backdrop-blur-md text-red-500 font-bold p-4 rounded-2xl shadow-sm border border-white/60 flex items-center justify-center gap-2 hover:bg-red-50 hover:border-red-100 transition-colors"
         >
