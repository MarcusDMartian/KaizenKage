            ...
            <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                     <div>
                        ...
                        <textarea
                           ...
                           className="w-full rounded-xl border-slate-200 dark:border-slate-600 dark:bg-slate-700 focus:border-indigo-500 p-3 text-sm"
                        />
                     </div>
                     <div>
                        <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">
               ...
               <div>
                  ...
                  <textarea
                     ...
                     className="w-full rounded-xl border-slate-200 dark:border-slate-600 dark:bg-slate-700 focus:border-indigo-500 p-4 text-sm"
                  />
               </div>
