      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6 bg-white p-4 rounded-xl border border-slate-100 shadow-sm">
        ...
        <div className="flex bg-slate-100 p-1 rounded-lg overflow-auto max-w-full">
          <button
            ...
            className={`px-4 py-2 rounded-md text-sm font-medium transition-all whitespace-nowrap ${period === 'month' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'
              }`}
          >
            This Month
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-md text-sm font-medium transition-all whitespace-nowrap ${period === 'quarter' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'
              }`}
          >
            This Quarter
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-md text-sm font-medium transition-all whitespace-nowrap ${period === 'all' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'
              }`}
          >
            All Time
          </button>
